...
# --------------------------------------------------------
# Vendorizado desde https://github.com/LeapLabTHU/DAT (commit 797f187f483dbc08620a878858b9bd72905e75b4)
# Parches locales respecto al original:
#   1. Shim de imports de timm (timm.layers en versiones nuevas, timm.models.layers en viejas)
#   2. torch.meshgrid(..., indexing='ij') explicito (mismo comportamiento, sin warning en torch>=2.x)
...
except ImportError:  # timm antiguo
